...
//   return (
//     <View style={tw`h-[95%]rounded-lg bg-white m-2`}>
//       {/* Table Header */}
//       <View
...
//           <View
//             style={tw`flex flex-row justify-between rounded-lg p-4 m-1 border-l border-r border-b`}
//           >
//             <Text style={tw`w-1/2 text-center pl-4 font-medium text-base`}>
//               {item}
//             </Text>
//             <View
...
//                 value={
//                   price[index] !== undefined ? price[index].toString() : "0"
//                 }
